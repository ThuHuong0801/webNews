...
<div class="col-sm-10">
	...
	<div class="col-sm-8">
		<div class="box profile__form">
			<?php
			echo isset($_GET['msg']) == true ? '<div class="alert alert-success">' . $_GET['msg'] . '</div>' : null;
			?>
			<form action="<?php '/admin/profile/saveEdit' ?>" method="post" enctype="multipart/form-data">
